                        ...
                        <div class="box-body">
                            <table id="job_list" class="table table-bordered table-striped" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th name="alarmEmail">${I18n.jobinfo_field_businessCode}</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_businessCode}<font
                                    color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="businessCode"
                                                     placeholder="${I18n.system_please_input}${I18n.jobinfo_field_businessCode}"
                                                     maxlength="50"></div>
                    </div>
                    <div class="form-group">
                        <label for="firstname"
